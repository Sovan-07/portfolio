...
const Projects = () => {
    const [selelctedProjectIndex , setSelectedProject] = useState(0);
    const currentProject = myProjects[selelctedProjectIndex];
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-12 w-full">
            <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
                ...
                <div className="flex flex-col gap-5 text-white my-5">
                    <p className="text-white text-2xl font-semobold animatedText">
